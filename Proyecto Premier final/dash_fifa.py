...
def grafica_goles(posicion):
    ...
    fig.update_layout(plot_bgcolor = "#eae2ce")
    fig.update_layout(paper_bgcolor = "#eae2ce")
...
def grafica_maximos_goleadores(posicion):
    ...
    fig.update_layout(bargap = 0.1)
    fig.update_layout(plot_bgcolor = "#cee9e2")
    fig.update_layout(paper_bgcolor = "#cee9e2")
...
def media_por_pos(checklist):
    ...
    fig.update_layout(title = 'Atributos Medios según la Posición')
    return (fig,{"display":"block"})
